...
class TestSubgraphContextPrompt(unittest.TestCase):
    ...
    def test_build_system_prompt_with_context(self):
        ...
        self.mock_store.get_subgraph_by_entities.return_value = {
            "nodes": [
                {"name": "AI", "entity_type": "concept", "mention_count": 1, "knowledge_state": "stable"},
                {"name": "AI Agent", "entity_type": "concept", "mention_count": 1, "knowledge_state": "hypothesis"},
    ...
    def test_generic_meta_nodes_are_ranked_lower(self):
        ...
        self.assertGreater(meta_nodes[0]["selection_score"], meta_nodes[1]["selection_score"])
    ...
    def test_context_result_to_dict_contains_debug_info(self):
        ...
        self.assertIn("selection_reason", data["debug_info"]["selected_nodes"][0])
